...
int abonnement_tel() {
    ...
    while (redo == 'O') {
        ...
        std::cout << "Voulez-vous refaire le test ? (O/N) ";
        std::cin >> redo;
    }
    return 0;
}
...
int calcul_caisse() {
    ...
    std::cout << "Donnez moi le nombre de pièces de 1 centimes : ";
    std::cin >> c1;
    std::cout << "Donnez moi le nombre de pièces de 2 centimes : ";
    std::cin >> c2;
    std::cout << "Donnez moi le nombre de pièces de 5 centimes : ";
    std::cin >> c5;
    std::cout << "Donnez moi le nombre de pièces de 10 centimes : ";
    std::cin >> c10;
    std::cout << "Donnez moi le nombre de pièces de 20 centimes : ";
    std::cin >> c20;
    std::cout << "Donnez moi le nombre de pièces de 50 centimes : ";
    std::cin >> c50;
    std::cout << "Donnez moi le nombre de pièces de 1 euros : ";
    std::cin >> e1;
    std::cout << "Donnez moi le nombre de pièces de 2 euros : ";
    std::cin >> e2;
